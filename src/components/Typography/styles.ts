...
export const typographyStyles = {
    displayLarge: { fontSize: 'text-6xl', fontWeight: 'font-normal', letterSpacing: 'tracking-tight' },
    displayMedium: { fontSize: 'text-5xl', fontWeight: 'font-normal', letterSpacing: 'tracking-tight' },
    displaySmall: { fontSize: 'text-4xl', fontWeight: 'font-normal', letterSpacing: 'tracking-tight' },
    ...
    displayLargeEmphasized: { fontSize: 'text-6xl', fontWeight: 'font-bold', letterSpacing: 'tracking-tight' },
    displayMediumEmphasized: { fontSize: 'text-5xl', fontWeight: 'font-bold', letterSpacing: 'tracking-tight' },
    displaySmallEmphasized: { fontSize: 'text-4xl', fontWeight: 'font-bold', letterSpacing: 'tracking-tight' },
    ...
    primary: { color: 'text-neutral-900', $dark: { color: 'dark:text-neutral-100' } },
    secondary: { color: 'text-neutral-400', $dark: { color: 'dark:text-neutral-600' } },
