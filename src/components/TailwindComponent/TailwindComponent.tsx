...
export type TailwindStyles =
  ...
  | TailwindStyles[]
  | undefined;
export type TailwindStylesMulti<T extends string = string> = Record<
  T,
  TailwindStyles
>;
...
type ComponentProps<T extends TailwindComponentTagName> =
...
export const TailwindComponent = <T extends TailwindComponentTagName>({
  as = 'div' as T,
  styles,
  children,
  ...props
